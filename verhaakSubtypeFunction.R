# Modified ovarian subtyping function

getVerhaakSubtypes <- function(eset, supplementary.data.sheet1, supplementary.data.sheet7) {
  
  #takes too long too long to open these so just send them in
  ...
  #only 2 columns for the one dataset after these 2 lines
  ...
  #one of the data sets GSE30009 crashes here as gsva only returns 2 columns not 4, no IMR column
